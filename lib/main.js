define(function(require) {
    ...
    const PlayList_AUTH_TOKEN = 'BQDumeswKQmIBbmDPHd4gvb65GbPqnEqV453J5HGdj1wFKqv1-6OotkNAJMxpsH22RaS5lVqLkVCySdw2bkKZbhHuhaal-9wFI0k8KgnEU2ns1AQZ89GaRXy7Wp7llOWHmHj6oTgDghiPZiSQhZvIZo516h2iWg'
        ...
        api.getCategories().then(({categories}) => {
            ...
            function getPlayList(){
                ...
                $.ajax({
                    ...
                    method: 'GET',
                    headers: {
                        Authorization: 'Bearer ' + PlayList_AUTH_TOKEN
                    },
